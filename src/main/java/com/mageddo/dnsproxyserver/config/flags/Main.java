...
public class Main {
//  flags/flags.go
  // todo configurar o jcommander e comecar a usar
  // https://github.com/mageddo-projects/portainer-cli/blob/master/src/main/java/com/mageddo/portainer/cli/command/PortainerCommand.java
  // https://github.com/mageddo/java-examples/tree/master/command-line-parser/jcommander/src/main/java/com/mageddo/jcommander/git
  // https://github.com/oracle/graal/issues/721

  // todo talvez testar o commons cli da apache pra ver se faz mais sentido usa lo cmo ele nao usa reflection
